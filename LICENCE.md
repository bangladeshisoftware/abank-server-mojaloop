...
The A Bank Server files are made available by Bangladeshi Software Ltd. under the
...
This project implements the **A Bank Server** — the core banking backend that
serves as a DFSP (Digital Financial Service Provider) in the Mojaloop ecosystem.
It provides the core transfer echo system enabling seamless interbank payment
transfers between A Bank and B Bank through the Mojaloop Switch.

**Key Features:**
- Core Transfer Echo System
- Mojaloop FSPIOP API Compliance
- Interbank Transfer Engine (A Bank ↔ B Bank)
- Account Management
- Transaction Ledger
